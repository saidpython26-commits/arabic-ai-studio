...
app.post('/api/gemini/slides', async (req, res) => {
  ...
  const fallbackSlides = {
    topic,
    summary: `شرح تفاعلي مبسط وشامل لمفهوم: ${topic} لترسيخ الفهم وتبسيط الأفكار المعقدة بأمثلة وتشبيهات واقعية وحركات حية.`,
    slideDuration: 12,
    slides: [
      {
        id: 's1',
        ...
        content: [
          ...
          `بدلاً من التعقيد، يمكن فهمه كنظام من الخطوات المترابطة بدقة.`,
        ...
        speechScript: `مرحباً بكم. اليوم سنشرح مفهوم ${topic} بطريقة مبسطة جداً. الفكرة الجوهرية تبدأ من إدراك الغاية العملية لهذا المفهوم، وكيف أنه يرتب الخطوات بسلاسة كإشارات المرور الذكية.`
      },
      {
        id: 's2',
        ...
        content: [
          ...
          'المرحلة الثالثة: إنتاج المخرجات أو النتيجة النهائية بدقة فائقة.'
        ],
        analogy: 'تماماً مثل إعداد وصفة متقنة: المكونات كمدخلات، والطهي كمعالجة، والطبق كمنتج نهائي.',
        keyTakeaway: 'كل خطوة تعتمد بالكامل على صحة الخطوة التي تسبقها مباشرة.',
        speechScript: `دعونا ننتقل الآن إلى آلية العمل خطوة بخطوة. تتكون الدورة من ثلاث مراحل رئيسية: أولاً استقبال المدخلات، ثانياً معالجتها بدقة، وثالثاً توليد المخرجات النهائية دون أخطاء.`
      },
      {
        id: 's3',
        ...
        content: [
          'تطبيقات حيوية في التكنولوجيا والأنظمة الحديثة.',
          'كيف يساعدنا هذا المفهوم في تحسين الكفاءة وتوفير الوقت والموارد.',
          'أمثلة واقعية نراها في حياتنا اليومية والمهنية دون أن نشعر.'
        ],
        analogy: 'مثل استخدام نظام الملاحة GPS؛ يرشدك لأقصر طريق متجاوزاً العقبات بذكاء.',
        keyTakeaway: 'النظريات تكتسب قيمتها الحقيقية عند تطبيقها على أرض الواقع لحل مشاكل حقيقية.',
        speechScript: `في التطبيق الواقعي، نرى أثر هذا المفهوم كأنظمة التوجيه الذكية؛ فهو يحول النظريات المجردة إلى حلول عملية توفر الجهد والوقت في حياتنا اليومية.`
      },
      {
        id: 's4',
        ...
        content: [
          ...
          'نصيحة المراجعة: ربط كل فكرة بتشبيه بصري يسهل استرجاعه أثناء الاختبار أو التطبيق.'
        ],
        analogy: 'مثل بناء بيت متين؛ إذا كانت الأساسات قوية، ستصمد الجدران أمام أي عاصفة.',
        keyTakeaway: 'الإتقان الحقيقي يعني قدرتك على شرح هذا الدرس لطفل في السابعة ببساطة ووضوح!',
        speechScript: `وأخيراً، القاعدة الذهبية لتفوقك: تجنب الخلط بين السبب والنتيجة، واحرص دائماً على ترسيخ الأساسات القوية، لأن الإتقان الحقيقي ينعكس في بساطة الشرح ووضوحه.`
      }
    ]
  };
